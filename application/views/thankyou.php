...
<!-- Mirrored from maxartkiller.com/website/finwallapp2/HTML/thankyou2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:07:41 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="logo-small">
                                    ...
                                    <h5><span class="text-secondary fw-light">STEPAKASH</span><br />Wallet</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-12 px-0 align-self-center">
                        <div class="row mx-0">
                            <div class="col-ld-6 position-relative thankyouimg2">
                                ...
                                <img src="<?php echo base_url() ?>assets/img/checkmark.svg" alt="" class="slideimg">
                            </div>
            ...
            <div class="col-11 col-sm-11 mt-auto mx-auto py-4">
                <div class="row ">
                    <div class="col-12 d-grid">
                        <a href="<?php echo base_url() ?>" class="btn btn-default btn-lg shadow-sm">Sign In</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from maxartkiller.com/website/finwallapp2/HTML/thankyou2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:07:42 GMT -->
</html>